(* This file duplicates Lsp.Text_document, because of a very strange bug
 * which occurred when using the original module:
 * Error: Files /home/.../.opam/default/lib/lsp/lsp.cmxa
          and /home/.../.opam/default/lib/uutf/uutf.cmxa
          make inconsistent assumptions over interface Uutf
 * Once this is resolved, usage of this module should be
 * replaced by Lsp.Text_document.
 *)
open Lsp
open Types
